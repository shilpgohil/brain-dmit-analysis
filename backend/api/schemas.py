...
class AnalysisResult(BaseModel):
    ...
    quotients: Optional[Dict[str, float]] = None
    pipeline_stages: List[PipelineStage] = []
...
class CreateSessionRequest(BaseModel):
    ...
    subject_dob: Optional[str] = None       # ISO date string YYYY-MM-DD, for PDF
    school: Optional[str] = None            # institution / school name, for PDF
    counsellor: Optional[str] = None        # counsellor name, for PDF
    parent_name: Optional[str] = None       # parent/guardian name, for PDF
