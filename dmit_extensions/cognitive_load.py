...
class CognitiveLoadExtension(DMITExtensionBase):
    ...
    def analyze(self, features: Dict[str, Any]) -> Dict[str, Any]:
        ...
        cognitive_styles = {
            'high_capacity': working_memory_capacity + attention_capacity,
            'fast_processor': processing_speed + cognitive_efficiency,
            'flexible_thinker': cognitive_flexibility + multitasking_capacity,
            'endurance_focused': mental_endurance + cognitive_recovery,
            'efficient_processor': cognitive_efficiency + processing_speed,
        ...
        return {
            ...
            'information_processing': working_memory_capacity + processing_speed,
            'attention_management': attention_capacity + cognitive_flexibility,
            'mental_stamina': mental_endurance + cognitive_recovery,
            'cognitive_optimization': cognitive_efficiency + multitasking_capacity,
            'load_handling_capacity': working_memory_capacity + mental_endurance,
