...
class PersistenceGritExtension(DMITExtensionBase):
    ...
    def analyze(self, features: Dict[str, Any]) -> Dict[str, Any]:
        ...
        grit_styles = {
            'goal_oriented': goal_persistence + achievement_drive,
            'consistent': effort_consistency + focus_persistence,
            'resilient': resilience + endurance,
            'determined': determination + motivation_persistence,
            'enduring': endurance + goal_persistence,
            'focused': focus_persistence + effort_consistency
        }
        ...
        return {
            ...
            'goal_achievement': goal_persistence + achievement_drive,
            'work_consistency': effort_consistency + focus_persistence,
            'stress_resistance': resilience + endurance,
            'motivation_stability': motivation_persistence + determination,
            'long_term_focus': focus_persistence + goal_persistence,
