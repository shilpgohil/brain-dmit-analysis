...
class NaturalisticIntelligenceExtension(DMITExtensionBase):
    ...
    def analyze(self, features: Dict[str, Any]) -> Dict[str, Any]:
        ...
        naturalistic_styles = {
            'environmental_observer': (environmental_awareness + environmental_sensitivity) / 2,
            'pattern_recognizer': (natural_pattern_recognition + natural_classification) / 2,
            'ecological_thinker': (ecological_understanding + natural_system_analysis) / 2,
            'biodiversity_expert': (biodiversity_recognition + environmental_adaptability) / 2,
            'natural_system_analyst': (natural_system_analysis + ecological_understanding) / 2,
        ...
        return {
            ...
            'environmental_perception': (environmental_awareness + environmental_sensitivity) / 2,
            'natural_analysis': (natural_pattern_recognition + natural_system_analysis) / 2,
            'ecological_expertise': (ecological_understanding + biodiversity_recognition) / 2,
            'environmental_adaptation': (environmental_adaptability + natural_classification) / 2,
            'natural_observation': (environmental_awareness + natural_pattern_recognition) / 2,
